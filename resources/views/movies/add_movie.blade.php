        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form method="POST" action="{{ route('movies.post') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <select class="form-control" name="distributor" required  autofocus>
                                ...
                                <option value="{{ $distributor->id }}" {{ old('distrbutor') == $distributor->id ? 'selected' : '' }}>{{ $distributor->name }}</option>
                                @endforeach
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                             <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description" rows="5" required  autofocus>{{ old('description') }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                            <input id="language" type="text" class="form-control @error('language') is-invalid @enderror" name="language" value="{{ old('language') }}" required  autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <select class="form-control" name="type" required  autofocus>
                                <option value="" selected>Please Select your choice</option>
                                <option value="1" {{ old('type' == 1 ? 'selected' : '') }}>Short Movie</option>
                                <option value="2" {{ old('type' == 2 ? 'selected' : '') }}>Long Movie</option>
                        ...
                        <div class="form-group row">
                            ...
                            <select class="form-control" name="premium_status" required  autofocus>
                                <option value="" selected>Please Select your choice</option>
                                <option value="0" {{ old('premium_status' == 0 ? 'selected' : '') }}>Free</option>
                                <option value="1" {{ old('premium_status' == 1 ? 'selected' : '') }}>Subscription</option>
                                <option value="2" {{ old('premium_status' == 2 ? 'selected' : '') }}>Rental</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                            <input id="amount" type="number" class="form-control @error('amount') is-invalid @enderror" name="amount" value="{{ old('amount') }}" step=0.01 {{ old('premium_status') == '2' ? '' : 'readonly' }}  autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                            <input id="length" type="number" class="form-control @error('length') is-invalid @enderror" name="length" value="{{ old('length') }}" required  autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                            <input id="release_date" type="text" readonly class="form-control @error('release_date') is-invalid @enderror" name="release_date" value="{{ old('release_date') }}" required  autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                            <input id="revenue" type="number" class="form-control @error('revenue') is-invalid @enderror" name="revenue" step=".01" value="{{ old('revenue') }}"  autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                            <input id="budget" type="number" class="form-control @error('budget') is-invalid @enderror" name="budget" step=".01" value="{{ old('budget') }}"  autofocus>
                        ...
                        <div class="text-center py-2">
                            <img id="bannerShow" src="" style="max-height: 250px;">
                        </div>
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-md-4">
                                <input id="banner" type="file" class=" form-control @error('banner') is-invalid @enderror" name="banner"  required  autofocus>
